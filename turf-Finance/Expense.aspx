                                ...
                                <table id="tblExpenseVoucherList" class="display  table-bordered" style="border-top: hidden!important; border-right: none; border-left: none; width: 100%">
                                    ...
                                    <tbody>
                                        <tr id="listrow0">
                                            ...
                                            <td>30,000.00</td>
                                            <td>
                                                <p id="lblStatusInvoice0">Unpaid</p>
                                            </td>
                                        ...
                                        <tr id="listrow2">
                                            ...
                                            <td>25,000.00</td>
                                            <td>
                                                <p id="lblStatusInvoice2">Partial Paid</p>
                                            </td>
                                        ...
                                        <tr id="listrow3">
                                            ...
                                            <td>25,000.00</td>
                                            <td>
                                                <p id="lblStatusInvoice3">Partial Paid</p>
                                            </td>
                                            <td>PTCL Bill Month of July 2019</td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr id="listrow4">
                                            ...
                                            <td>25,000.00</td>
                                            <td>
                                                <p id="lblStatusInvoice4">Unpaid</p>
                                            </td>
                                            <td>PTCL Bill Month of July 2019</td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr id="listrow5">
                                            ...
                                            <td>25,000.00</td>
                                            <td>
                                                <p id="lblStatusInvoice5">Unpaid</p>
                                            </td>
                                            <td>PTCL Bill Month of July 2019</td>
                                            <td></td>
                                            <td></td>
            ...
            <div id="vendor" class="tab-pane fade">
                <div class="content" id="VendorList">
                    <div class="container-fluid">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-7 text-right">
                                        <div class="form-group">
                                            <%--<button type="button" onclick="GetAllVendor();" class="btn btn-success btn-wd btn-fill">Show InActive Vendor</button>--%>
                                          
                                            
                                                <span class="btn btn-success btn-sm btn-fill" style="height:38px !important" ><span><input type="checkbox" name="abc" onchange="GetVendors();" id="chkShowInactive"  /></span> <label for="chkShowInactive">Show InActive</label>  </span>
                                                   
                                            <%--<input type="checkbox" onchange="GetVendors();" id="chkShowInactive" class="btn btn-success btn-wd btn-fill" />--%>
                                            <button type="button" class="btn btn-success  btn-fill" id="btnAddVendor" onclick="AddNewVendor();">Add New Vendor </button>
                                            <button type="button" id="btnShowVendorTransaction" onclick="ShowVendorTransaction();" class="btn btn-success btn-wd btn-fill">Show  Transaction</button>
                                        </div>
                                    </div>
                                </div>
                                <hr />
                                <div class="row clearfix">
                                    <div class="col-md-12 table-responsive">
                                        <table id="VendorBalance" class="display  table-bordered" style="border-top: hidden!important; border-right: none; border-left: none; width: 100%">
                                            <thead>
                                                <tr style="border-top: hidden;">
                                                    <th>Vendor</th>
                                                    <th>Total Amount</th>
                        ...
                        <hr />
                        <div id="showVendorTransaction" style="display: none">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-8">
                                        <div class="col-md-2 labelWidth PaddingClass">
                                        ...
                                        <div class="col-md-12">
                                            <table id="demoGridForVendorList" class="display  table-bordered" style="border-top: hidden!important; border-right: none; border-left: none; width: 100%">
                                                <thead>
                                                    <tr style="border-top: hidden;">
                                                        <th>
                                                            <input type="checkbox" id="chkAllVendor" disabled="disabled" /></th>
                                                        <th>Vendor</th>
                                                        <th>Invoice No</th>
                                                        <th>Invoice Date</th>
                                                        <th>Voucher No</th>
                                                ...
                                                <tbody>
                                                    <tr id="vendorListRow0">
                                                        ...
                                                        <td>30,000.00</td>
                                                        <td>
                                                            <p id="lblVendStatusInvoice0">Unpaid</p>
                                                        </td>
                                                        <td>Electricity Bill Month of July 2019</td>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr id="vendorListRow1">
                                                        <td>
                                                            <input type="checkbox" /></td>
                                                        <td>Shakir</td>
                                                        <td>Invoice No 2</td>
                                                        ...
                                                        <td>20,000.00</td>
                                                        <td>
                                                            <p id="lblVendStatusInvoice1">Unpaid</p>
                                                        </td>
                                                        <td>Internet Bill Month of July 2019</td>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr id="vendorListRow2">
                                                        <td>
                                                            <input type="checkbox" /></td>
                                                        <td>Adnan</td>
                                                        <td>Invoice No 3</td>
                                                        ...
                                                        <td>25,000.00</td>
                                                        <td>
                                                            <p id="lblVendStatusInvoice2">Paid</p>
                                                        </td>
                                                        <td>PTCL Bill Month of July 2019</td>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr id="vendorListRow3">
                                                        <td>
                                                            <input type="checkbox" /></td>
                                                        <td>Adnan</td>
                                                        <td>Invoice No 4</td>
                                                        ...
                                                        <td>25,000.00</td>
                                                        <td>
                                                            <p id="lblVendStatusInvoice3">Unpaid</p>
                                                        </td>
                ...
                <div class="header">
                    <div class="row">
                        ...
                        <div class="col-md-4 " style="padding-top: 3%;">
                            ...
                            <div class="col-md-2 ">
                                <a id="CloseCustomerInformationForm" onclick="show_confirmVendorInformation('Do You Want To Leave Without Saving')"><i class="fa fa-times fa-lg"></i></a>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <span class="form-control border-input">
                                    <input type="checkbox"  id="chkStatus" /><label id="ShowVendorStatus" for="chkStatus">Active</label></span>
                            </div>

                        </div>
                        <div class="col-md-9 text-right" style="padding-top: 1%">
                            <button type="button" id="btnEditVendor" onclick="EnableVendor();" class="btn btn-info btn-fill btn-sm btn-wd ">Edit</button>
                            <button type="button" id="btnSaveVendor" onclick="ValidateVendor();" class="btn btn-info btn-fill btn-sm btn-wd ">Save</button>
                            <a class="btn btn-info btn-fill btn-sm btn-wd " onclick="VerifyVendor();">FBR Verification</a>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <table id="btnTable" class=" table">
                        ...
                        <tr>
                            ...
                            <td>
                                <label id="lblSummeryPayAmount" style="width: 50%; text-align: right">0.00</label></td>
                        </tr>
                        <tr>
                            <td>
